...
describe SimpleNavigation::Helpers do
  ...
  def whitebox_setup
    ...
    SimpleNavigation.stub(:load_config)
    SimpleNavigation::Configuration.stub(:eval_config)
    @primary_navigation = double(:primary_navigation).as_null_object
  ...
  describe 'render_navigation' do
    ...
    context 'rendering of the item_container' do
      before(:each) do
        @active_item_container = double(:item_container).as_null_object
    ...
    context 'secondary' do
      context 'with current_primary_navigation set' do
        before(:each) do
          @selected_item_container = double(:selected_container).as_null_object
